...
// https://github.com/esnya/EsnyaSFAddons/blob/d2984ab062190521d701c9b4651c84abc6e424b9/Packages/com.nekometer.esnya.esnya-sf-addons/Scripts/SFEXT/SFEXT_BoardingCollider.cs
namespace VAU.V320NeoNext.Runtime.Systems.BoardingCollider.SaccExt
{
    /// <summary>
    ...
    public class SFEXT_BoardingCollider : UdonSharpBehaviour
    {
        ...
        public override void PostLateUpdate()
        {
            ...
            if (playerStay)
            {
                ...
                {
                    localPlayer.TeleportTo(nextPlayerPosition,
                        playerRotation * Quaternion.Slerp(rotationDiff, Quaternion.identity, 0.5f));
                }
            }
